...
/**
 * This is the extension manager of the Dynamicpractice extension.
 */
public class DynamicpracticeManager extends GeneratedDynamicpracticeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DynamicpracticeManager.class.getName());
	 ...
	 */
	public static DynamicpracticeManager getInstance()
	{
		return (DynamicpracticeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DynamicpracticeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DynamicpracticeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DynamicpracticeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DynamicpracticeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DynamicpracticeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
